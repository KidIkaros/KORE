...
impl KoreVulkanBuffer {
    ...
    pub fn to_storage(&self) -> Result<Storage> {
        ...
        self.buffer.copy_to_host(&mut data, 0)
            .map_err(|e| VulkanError::Transfer(e.to_string()))?;
